...
const Dashboard = () => {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 max-w-2xl">
              Monitor your API testing performance and track key metrics in
              real-time
            </p>
          </div>
                ...
                <div className="flex items-center justify-center h-full">
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center mb-4 mx-auto">
                      {currentTrend?.icon && (
                        <currentTrend.icon className="w-8 h-8 text-gray-400" />
                      )}
                    </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-sm font-semibold text-gray-900">
              {environment.successRate}%
            </p>
            <span
              className={`text-xs px-2 py-1 rounded-full border ${colors[status]}`}
            >
              {status}
            </span>
          </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      {item.executionCount || 0} executions
                    </p>
                  </div>
                </div>
                <div className="text-right">
            ...
            <div className="flex-1 flex items-center justify-center text-center py-8">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  No critical issues detected in your test suites
                </p>
  ...
  // Enhanced Recent Executions Component with better data handling
          ...
          {executions?.length > 0 ? (
            executions.slice(0, 5).map((execution, index) => (
              <div
                ...
                className="p-4 border border-gray-200 rounded-xl hover:bg-gradient-to-r hover:from-gray-50 hover:to-indigo-50 hover:border-indigo-200 transition-all duration-200 cursor-pointer"
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <Badge
                      variant={
                        execution.executionStatus?.toLowerCase() === 'passed'
                          ? 'success'
